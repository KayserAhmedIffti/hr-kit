            ...
            >
                ...
                >
                    ...
                    <div class="sidebar-brand-text mx-3">
                        Skylark Soft Limited <sup>2</sup>
                    </div>
                </a>
                ...
                <li class="nav-item">
                    ...
                    >
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <router-link class="collapse-item" to="/departments"
                                >Department</router-link
                            >
                            <router-link class="collapse-item" to="/positions"
                                >Position</router-link
                            >
                            <router-link class="collapse-item" to="/employees"
                                >Employee Entry</router-link
                            >
                        </div>
                    </div>
                </li>
...
export default {
    ...
    methods: {
        logout() {
            this.axios
                .post("/api/v1/auth/logout", this.auth.user)
                .then(({ data }) => {
                    Auth.logout();
